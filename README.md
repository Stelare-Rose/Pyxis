...
# Platform Support
Currently the project only supports Linux, and provides a manual Nix build. It's not currently recommended to use this application though as it's still immature.
